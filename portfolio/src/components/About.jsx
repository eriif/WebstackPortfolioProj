...
const About = () => {
  return (
    <div className="w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 lg:gap-20 lg:py-20">
	 <div className="w-64 h-64 flex flex-col items-center border border-gray-500 dark:bg-transparent rounded-full">
	  <img
          src={Profile}
          alt="about"
      ...
      <div className="w-full flex flex-col">
        ...
        <p className="text-lg text-black dark:text-gray-400 leading-10">
          I'm passionate full-stack software developer with  the aim of solving real-world problems through developing suitable applications. I'm able to apply my skills to create innovative solutions and deliver high-quality software.
        </p>
        <div
