    ...
    <div className="w-full flex flex-col py-20">
        ...
        {skills.map((skill, index) => (
          ...
          >
            <div className="w-10 h-10">
              <img src={skill.icon} alt="icon" className="w-full h-full " />
            </div>
      ...
      <div className="mt-[10rem]">
        ...
        <div className="flex flex-col md:flex-row gap-16 items-center justify-center">
          <div className="flex flex-col bg-[#000000] dark:bg-[#224cff10] p-6 rounded-xl hover:scale-125 ease-in-out duration-500 mb-10 md:mb-0">
          ...
          <div className="flex flex-col bg-[#000000] dark:bg-[#224cff10] p-6 rounded-xl scale-110 hover:scale-125 ease-in-out duration-500 mb-10 md:mb-0">
